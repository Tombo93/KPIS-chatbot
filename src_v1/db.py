...
def gen_data_presseportal():
    with sqlite3.connect("presseportal_prompts.db") as con:
        cur = con.cursor()
        cur.execute("DROP TABLE IF EXISTS presseportal_prompts")
        cur.execute("""
        ...
        entries = [(
            ...
            "Retrieve the latest 20 politics stories in German as images. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the limit of 20. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. storytype politics 3. API key 4. 20 stories 5. language"
        ),
        (
            ...
            "Retrieve 15 sports stories in English starting from offset 10. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the pagination start at 10. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. sports 3. API key 4. 15 stories 5. start offset 10 6. english"
        ),
        (
            ...
            "Retrieve the latest 30 nature stories in French. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the limit of 30. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. nature 3. API key 4. 30 stories 5. french"
        ),
        (
            ...
            "Retrieve the latest 25 health stories in German as images with HTML-encoded body. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the limit of 25. Also, set the language parameter and encoded=1. Finally, output the endpoint.",
            "1. base-URL 2. health 3. API key 4. 25 stories 5. german 6. html encoded body"
        ),
        (
            ...
            "Retrieve the latest 50 economy stories in English. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the limit of 50. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. economy 3. API key 4. 50 stories 5. english"
        ),
        (
            ...
            "Retrieve 5 science stories in Spanish as images starting from offset 5. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the pagination start at 5. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. science 3. API key 4. 5 stories 5. start offset 5 6. spanish"
        ),
        (
            ...
            "Retrieve the latest 40 travel stories in Italian. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the limit of 40. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. travel 3. API key 4. 40 stories 5. italian"
        ),
        (
            ...
            "Retrieve the latest 12 technology stories in English as images with HTML-encoded body. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the limit of 12. Also, set the language parameter and encoded=1. Finally, output the endpoint.",
            "1. base-URL 2. technology 3. API key 4. 12 stories 5. english 6. html encoded body"
        ),
        (
            ...
            "Retrieve 10 education stories in German starting from offset 20. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the pagination start at 20. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. education 3. API key 4. 10 stories 5. start offset 20 6. german"
        ),
        (
            ...
            "Retrieve the latest 18 entertainment stories in French as images. First, set the base-URL and then identify the storytype. Next, set the API key parameter. Then, specify the limit of 18. Also, set the language parameter. Finally, output the endpoint.",
            "1. base-URL 2. entertainment 3. API key 4. 18 stories 5. french"
        )]
        cur.executemany("""
